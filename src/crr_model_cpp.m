...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if isfield(loss,'lambda') && ~isempty(loss.lambda) && loss.lambda > 0
        error('crr_model_cpp:UnsupportedLoss', ...
            ['The unified C++ backend does not support the soil-moisture ' ...
             'objective (loss.lambda > 0); use misc.crr_backend = ' ...
             '''matlab''.']);
    end
